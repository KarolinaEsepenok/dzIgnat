...
const initialPeople:UserPropsType[] = [
...
function HW8() {
    const [people, setPeople] = useState<UserPropsType[]>(initialPeople) // need to fix any

    // need to fix any

    const finalPeople = people.map((p: UserPropsType) => (
